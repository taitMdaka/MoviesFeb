angular.module('OurMoviesService', [])
    .factory('ourMoviesServ', function ($http) {
        var ListOurMovies = function () {
            return $http.get('/api/adminweb/GetAllTestimonies', { cache: true }).then(function (data) {
                return data.data;
            });
//        }

//        var addTestimony = function (addTestimonyCommand) {
//            return $http.post('/api/adminweb/AddTestimonies', addTestimonyCommand).then(function (data) {
//                return data.data;
//            });
//        }
